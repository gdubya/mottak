...
{% block:breadcrumb %}
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">{% if(empty($invitation->archive_type_id)) %}Fullfør opprettelse av invitasjon til opplasting{% else %}Rediger invitasjon til opplasting{% endif %}</li>
		</ol>
	</nav>
{% endblock %}
